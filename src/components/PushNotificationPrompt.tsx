  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div style={{ width: 40, height: 40, borderRadius: 12, background: 'linear-gradient(135deg, #7C3AED, #22D3EE)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            <button
              ...
              disabled={loading}
              style={{ padding: '8px 14px', borderRadius: 9, background: '#7C3AED', color: '#FFFFFF', border: 'none', fontSize: 12, fontWeight: 700, cursor: loading ? 'default' : 'pointer', opacity: loading ? 0.7 : 1, fontFamily: 'var(--font-sans)' }}
            >
              {loading ? '…' : 'Enable'}
            </button>
            <button
