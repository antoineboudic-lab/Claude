...
export default function TeamsPage() {
  ...
  return (
    <main style={{ background: '#F8FAFC', minHeight: '100vh', fontFamily: 'var(--font-sans)' }}>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <motion.div
            ...
            <motion.h1 variants={fadeUp}
              ...
              <span style={{ color: '#7C3AED' }}>team in AI</span> — together
            </motion.h1>
      ...
      {/* Social proof bar */}
      <div className="py-6" style={{ background: '#F8FAFC', borderTop: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0' }}>
        <div className="max-w-5xl mx-auto px-6">
      ...
      {/* Testimonials */}
      <div className="py-16" style={{ background: '#F8FAFC', borderTop: '1px solid #E2E8F0' }}>
      ...
      {/* Features */}
      <div className="py-20" style={{ background: '#F8FAFC', borderTop: '1px solid #E2E8F0' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Built for teams</p>
            ...
            {FEATURES.map(f => {
              ...
              return (
                <div key={f.title} className="p-6 rounded-2xl"
                  style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4" style={{ background: '#EDE9FE' }}>
      ...
      <div id="plans" className="py-20" style={{ background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Team pricing</p>
            ...
            {PLANS.map(plan => (
              <div key={plan.name}
                ...
                style={{
                  ...
                  boxShadow: plan.highlight ? '0 20px 60px rgba(124,58,237,0.25)' : '0 1px 3px rgba(0,0,0,0.04)',
                }}>
                {plan.highlight && (
                  ...
                  {plan.features.map(f => (
                    <li key={f} className="flex items-start gap-2.5 text-sm"
                      ...
                      <CheckCircle2 size={14}
                        style={{ color: plan.highlight ? '#A78BFA' : plan.color, flexShrink: 0, marginTop: 1 }} />
                      {f}
                    </li>
                  ))}
                </ul>
          ...
          <p className="text-center text-sm mt-8" style={{ color: '#94A3B8' }}>
            ...
            <button onClick={openSignUp} className="font-semibold hover:underline" style={{ color: '#7C3AED' }}>
      ...
      <div id="contact" className="py-20" style={{ background: '#FFFFFF' }}>
        <div className="max-w-lg mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Get in touch</p>
