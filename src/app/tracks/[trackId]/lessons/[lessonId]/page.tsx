    ...
    <div>
      <ReactMarkdown
        components={{
          ...
          blockquote: ({ children }) => (
            <div className="my-5 pl-4 py-3 pr-3"
              style={{ borderLeft: '2px solid #E2E8F0', background: '#F8FAFC' }}>
          ...
          {!critique && (
            <div className="px-5 pb-4">
              <button
                ...
                style={{ background: '#F3F0FF', color: '#7C3AED', border: '1px solid #DDD6FE', fontFamily: 'var(--font-sans)' }}>
                {critiqueLoading
        ...
        {critique && showCritique && (
          <motion.div
            ...
            <div className="px-5 py-3.5 flex items-center justify-between"
              style={{ background: 'linear-gradient(135deg, #EDE9FE, #F5F3FF)', borderBottom: '1px solid #DDD6FE' }}>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5">
                <div className="relative w-9 h-9">
                  <svg viewBox="0 0 36 36" className="w-9 h-9 -rotate-90">
                    <circle cx="18" cy="18" r="15.9" fill="none" stroke="#DDD6FE" strokeWidth="3.5" />
                    <circle
                      cx="18" cy="18" r="15.9" fill="none"
                      stroke={critique.score >= 7 ? '#7C3AED' : critique.score >= 4 ? '#F59E0B' : '#EF4444'}
                      strokeWidth="3.5"
                  ...
                  <span className="absolute inset-0 flex items-center justify-center text-xs font-black"
                    style={{ color: critique.score >= 7 ? '#7C3AED' : critique.score >= 4 ? '#D97706' : '#DC2626', fontFamily: 'var(--font-sans)' }}>
                    {critique.score}
                  </span>
                </div>
            ...
            <div className="p-5 space-y-4" style={{ background: '#FEFCFF' }}>
              ...
              <div className="p-3.5 rounded-xl flex items-start gap-2.5"
                ...
                <Zap size={12} color="#7C3AED" className="flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-[11px] font-bold mb-0.5 uppercase tracking-wide" style={{ color: '#7C3AED', fontFamily: 'var(--font-sans)' }}>
                    Top tip
                  </p>
                  <p className="text-xs leading-relaxed" style={{ color: '#6D28D9', fontFamily: 'var(--font-sans)' }}>
                    {critique.topTip}
                  </p>
                </div>
              </div>
        ...
        >
          ...
          {!isInPath && (
            <div className="flex items-start sm:items-center gap-3 px-4 py-3 rounded-lg"
              ...
              <p className="text-xs leading-relaxed flex-1" style={{ color: '#6D28D9', fontFamily: 'var(--font-sans)' }}>
