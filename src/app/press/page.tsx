...
export default function PressPage() {
  return (
    <main style={{ background: '#F8FAFC', minHeight: '100vh', fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="py-20 sm:py-24" style={{ background: '#FFFFFF' }}>
        <div className="max-w-4xl mx-auto px-6">
          <motion.div variants={stagger(0.1)} initial="hidden" animate="visible">
            <motion.p variants={fadeUp} className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Press & Media</motion.p>
            ...
            <motion.p variants={fadeUp} className="text-lg max-w-2xl" style={{ color: '#64748B' }}>
              ...
              <a href="mailto:press@ailiteracy.com" style={{ color: '#7C3AED', fontWeight: 600 }}>press@ailiteracy.com</a>
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Stats */}
      <section className="py-12" style={{ background: '#F8FAFC', borderTop: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0' }}>
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {STATS.map(s => (
              <div key={s.label} className="text-center">
                <p className="text-3xl font-black mb-1" style={{ color: '#7C3AED' }}>{s.value}</p>
      ...
      {/* Press kit */}
      <section className="py-16 pb-24" style={{ background: '#F8FAFC' }}>
        <div className="max-w-4xl mx-auto px-6">
