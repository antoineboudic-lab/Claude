  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        {Array.from({ length: Math.ceil(all.length / 3) }, (_, rowIndex) =>
          all.slice(rowIndex * 3, rowIndex * 3 + 3)
        ).map((row, rowIndex) => (
                    ...
                    {isHovered && (
                      ...
                      >
                        ...
                        <div className="absolute left-1/2 bottom-0 -translate-x-1/2 translate-y-full w-0 h-0"
                          style={{ borderLeft: '6px solid transparent', borderRight: '6px solid transparent', borderTop: '6px solid #FFFFFF' }} />
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
