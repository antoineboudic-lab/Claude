...
const POSTS: Record<string, PostData> = {
  ...
  'legal-ai-contract-review': {
    ...
    authorRole: 'General Counsel, Stripe',
    date: 'March 31, 2026',
    readTime: '7 min read',
    trackSlug: 'legal',
  ...
  'customer-success-ai-retention': {
    ...
    author: 'Lena Vasquez',
    authorRole: 'Head of Customer Success, HubSpot',
    date: 'March 17, 2026',
    readTime: '6 min read',
    trackSlug: 'customer',
  ...
  'consulting-ai-research': {
    ...
    authorRole: 'Partner, McKinsey & Company',
    date: 'March 10, 2026',
    readTime: '9 min read',
    ...
    <main style={{ background: '#F8FAFC', minHeight: '100vh', fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="mt-16 rounded-2xl p-8 text-center"
          style={{ background: '#7C3AED', boxShadow: '0 8px 32px rgba(124,58,237,0.2)' }}>
