      ...
      <section className="py-16 sm:py-20" style={{ background: '#FFFFFF' }}>
        <div className="max-w-3xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Help centre</p>
            ...
            <p className="text-lg" style={{ color: '#64748B' }}>
              ...
              <a href="mailto:hello@ailiteracy.com" style={{ color: '#7C3AED', fontWeight: 600 }}>Get in touch.</a>
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-[220px_1fr] gap-10">
            ...
            <div>
              ...
              <div className="rounded-2xl overflow-hidden px-6" style={{ background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
