    ...
    <main style={{ background: '#F0FDFA', minHeight: '100vh', fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="py-20 sm:py-28" style={{ background: '#FFFFFF' }}>
        <div className="max-w-4xl mx-auto px-6">
          <motion.div variants={stagger(0.1)} initial="hidden" animate="visible">
            <motion.p variants={fadeUp} className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#0D9488' }}>Careers</motion.p>
            <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl font-black tracking-tight leading-[1.1] mb-5" style={{ color: '#0F172A' }}>
              Build the future of<br /><span style={{ color: '#0D9488' }}>professional learning</span>
            </motion.h1>
            ...
            {PERKS.map(p => {
              ...
              return (
                <div key={p.title} className="p-6 rounded-2xl" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center mb-4" style={{ background: '#CCFBF1' }}>
      ...
      <section className="py-16 pb-24" style={{ background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-12 p-8 rounded-2xl text-center" style={{ background: '#F0FDFA', border: '1px solid #E2E8F0' }}>
