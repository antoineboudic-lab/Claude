        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div variants={stagger(0.1)} initial="hidden" animate="visible">
            ...
            <motion.h1 variants={fadeUp}
              ...
              style={{ color: '#0F172A' }}>
              Certificates that<br /><span style={{ color: '#7C3AED' }}>mean something</span>
            </motion.h1>
      ...
      <section className="py-20" style={{ background: '#F8FAFC' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>What you earn</p>
            ...
            <div className="relative">
              <div className="rounded-2xl p-8"
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-md font-semibold" style={{ background: '#EDE9FE', color: '#7C3AED' }}>Verified</span>
                </div>
                <div className="text-center py-6" style={{ borderTop: '1px solid #F1F5F9', borderBottom: '1px solid #F1F5F9' }}>
                  ...
                  <p className="text-sm" style={{ color: '#64748B' }}>Awarded to <strong style={{ color: '#7C3AED' }}>Sophie Armand</strong></p>
                </div>
