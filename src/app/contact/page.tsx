      ...
      <section className="py-16 sm:py-24" style={{ background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-[1fr_400px] gap-16 items-start">
            {/* Left */}
            <div>
              <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: '#7C3AED' }}>Contact</p>
              ...
              <div className="space-y-5">
                {[
                  { icon: Mail, label: 'General enquiries', value: 'hello@ailiteracy.com', color: '#7C3AED' },
